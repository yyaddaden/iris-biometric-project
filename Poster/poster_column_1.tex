\block{Problématique}{
       { \fontsize{40}{40}\selectfont 
		...
		Avec le développement des systèmes d'information et l'utilisation d'outils informatique, il y a de plus en plus de : \vspace{0.5em}
		...
		Le méthode de sécurité classiques ne suffisent plus, il est par conséquent primordial de mettre en place des mesures de sécurité robustes. \vspace{0.5em}
...
\block{Objectifs}{
	...
	\begin{itemize}
		...
		\item[$\checkmark$] Mettre le système à disposition à travers une \textbf{API REST} destiné aux applications Web et mobiles.
	\end{itemize}
	}
}	
