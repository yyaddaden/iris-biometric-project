...
\cite{ref_03}
\\~\\
Pour ce projet, j'ai transformé la matrice 2D GLCM en un vecteur 1D grâce à la méthode « flatten » de « numpy ». Ensuite, j'ai appliqué la méthode « PCA » de « scikit-learn ».
